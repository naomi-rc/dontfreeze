...
## Creators/Créateurs :
Jonathan Bouchard - programmer,  game designer

Naomi Catwell - programmer, composer, animator,  sound design, game designer

Djinah Demetrius - programmer, animator,  game designer

William Lortie - programmer, game designer

Date : Mai 2022 - August 2022



## Fonctionnalités implémentées :
### Naomi Catwell:
- Mécanismes de santé, de vie et de dommages
- Game design (design du monde et des abris)
- Intelligence artificielle implémenté avec un arbre de décision et machine à états
- Navigation des ennemis avec NavMesh
- Génération de niveau procédural
- Génération et instanciation aléatoire des ennemis et collectibles
- Effets sonores et composition de musique de fond
- Cutscenes de début et de fin (vidéo d'introduction)

### Djinah Demetrius 
- UI, HUD et menus
- Contrôle et animation des personnages (déplacer, sauter, courir, attaquer, mourir)
- Physique et collisions
- UI et fonctionnalité de la carte des niveaux

### William Lortie
- UI, HUD et menus
- Mécanismes de santé, de vie et de dommages
- Game design (design du monde et des abris)
- Création de système d'inventaire
- Système de sauvegarde de l'état du jeu
- Gestion et transition des scènes
- Système de récupération de collectibles
- Skybox et shaders personnalisés
- Systèmes de particules personnalisés
- Système d'armure et de crafting
